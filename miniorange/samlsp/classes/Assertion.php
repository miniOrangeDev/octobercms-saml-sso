...
namespace Miniorange\Samlsp\Classes;
...
use Miniorange\Samlsp\Helper\Exception\InvalidSAMLVersionException;
use Miniorange\Samlsp\Helper\Exception\MissingIDException;
use Miniorange\Samlsp\Helper\Exception\MissingIssuerValueException;
use Miniorange\Samlsp\Helper\Exception\InvalidNumberOfNameIDsException;
use Miniorange\Samlsp\Helper\Exception\MissingNameIdException;
...
class Assertion
{
    ...
    public function __construct(DOMElement $xml = NULL)
    {
		...
		if($xml->localName === 'EncryptedAssertion')
		{
				...
				$blacklist = array();
				$xml = samlutilities::decryptElement($data[0], $key, $blacklist, $key);
		}
