...
use Miniorange\Samlsp\Helper\Exception\SAMLResponseException;
...
class TestResultActions
{
    ...
    private function processTemplateHeader()
    {
        ...
        $header = str_replace("{{right}}","plugins/miniorange/samlsp/resources/images/right.png",$header);
        $header = str_replace("{{wrong}}","plugins/miniorange/samlsp/resources/images/wrong.png", $header);
