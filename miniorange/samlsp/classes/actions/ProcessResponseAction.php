...
use Exception;
use Miniorange\Samlsp\Classes\SamlResponse;
use Miniorange\Samlsp\Helper\Exception\InvalidAudienceException;
use Miniorange\Samlsp\Helper\Exception\InvalidDestinationException;
use Miniorange\Samlsp\Helper\Exception\InvalidIssuerException;
use Miniorange\Samlsp\Helper\Exception\InvalidSamlStatusCodeException;
use Miniorange\Samlsp\Helper\Exception\InvalidSignatureInResponseException;
use Miniorange\Samlsp\Helper\Lib\XMLSecLibs\XMLSecurityKey;
use Miniorange\Samlsp\Helper\PluginSettings;
use Miniorange\Samlsp\Helper\samlutilities;
...
class ProcessResponseAction
{
    ...
    private function validateDestinationURL()
    {
        ...
        if ($msgDestination !== NULL && $msgDestination !== $this->acsUrl)
            throw new InvalidDestinationException($msgDestination,$this->acsUrl,$this->samlResponse->getXML());
    }
}