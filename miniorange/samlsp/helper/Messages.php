...
class Messages
{
    ...
    const INVALID_RESPONSE_SIGNATURE 	= '<strong>INVALID_SIGNATURE: Configure your X-509 Certificate at <a href="{{http-host}}">SAML Settings</a> to be the one shown below and please try again.</strong><br><p class="error-cert">-----BEGIN CERTIFICATE-----<br>{{cert}}<br>-----END CERTIFICATE-----</p>';
    ...
    const INVALID_ISSUER                = 'IDP Entity ID mismatch. <strong>Please configure {{found}} as Entity ID at <a href="{{http-host}}">SAML Settings</a></strong>';
